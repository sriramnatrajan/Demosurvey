...
class TRExpAdapter extends BaseExpandableListAdapter {
    ...
    TRExpAdapter(Context context, List<Question> questionList) {
        mContext = context;
    ...
    public View getChildView(final int listPosition, final int expandlistPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        switch (questiontype) {
            case "Comment":
                ...
                break;
            default:
                final RadioButton radio_option1 = convertView.findViewById(R.id.radio_option1);
                final RadioButton radio_option2 = convertView.findViewById(R.id.radio_option2);
                final RadioButton radio_option3 = convertView.findViewById(R.id.radio_option3);
                final RadioButton radio_option4 = convertView.findViewById(R.id.radio_option4);
                final EditText EditText_comments = convertView.findViewById(R.id.EditText_comments);
                ...
                convertView.findViewById(R.id.Liner_multiple).setVisibility(View.VISIBLE);
...
/*
       radio_option1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
        ...
        // EditText_comments.setText(content);
    ...
    @Override
    public View getGroupView(final int listPosition, final boolean isExpanded, View convertView, ViewGroup viewGroup) {
